...
alias cb='cp -f /etc/skel/.bashrc* ~/ && exec bash'
alias cz='cp -f /etc/skel/.zshrc* ~/ && cp -fr /etc/skel/.oh-my-zsh ~/ && exec zsh'
alias cf='cp -f /etc/skel/.config/fish/*.fish ~/.config/fish/ && exec fish'
