...
alias .f='cd ~/.dotfiles'
alias cc='cd ~/.config/suckless/chadwm'
alias cf='cd ~/.config/fish'
alias cs='cd ~/.config/suckless/sxhkd'
alias cr='cd ~/.config/suckless/scripts'
...
alias eb='vim ~/.bashrc'
alias ec='vim ~/.config/suckless/chadwm/config.def.h'
...
alias er='vim ~/.config/suckless/scripts/run.sh'
alias es='vim ~/.config/suckless/sxhkd/sxhkdrc'
